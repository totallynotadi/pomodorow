...
streams = [
    ...
    "https://www.youtube.com/watch?v=GTZROPwG3Pk",
    "https://www.youtube.com/watch?v=o5Gv4_FdcYs",
    "https://www.youtube.com/watch?v=_ITiwPMUzho",
    "https://www.youtube.com/watch?v=8TlQMC-Njrs",
    "https://www.youtube.com/watch?v=O3UenuM-SYY",
    "https://www.youtube.com/watch?v=Vdxp5H2vOdU",
    "https://www.youtube.com/watch?v=X9EY84-Hzls",
    "https://www.youtube.com/watch?v=q55qNEKQLG0",
    "https://www.youtube.com/watch?v=KTRRp9N7BTc",
    "https://www.youtube.com/watch?v=rY0mSSOnkL0",
    "https://www.youtube.com/watch?v=eGy-E8-cTjQ",
    "https://www.youtube.com/watch?v=t_i_Dq2GjAI",
]
ambience = [
    "https://www.youtube.com/watch?v=9oc8Fa7tb8c",
...
MUSIC_STATE = "playing"
yt_config = YoutubeDL({"quiet": True, "format": "bestaudio"})
...
def play(url, volume=1.0):
    ...
    duration = int(str(player.get_metadata()["duration"]).split(".", maxsplit=1)[0])
    while True:
        ...
        if updated_pts == last_pts != 0:
            if last_pts == 0 and updated_pts == 0:
                pass
            player.toggle_pause()
...
def timer_thread(work_time, break_time, player):
    """
...
if __name__ == "__main__":
    ...
    le_threads = [
        {"func": timer_thread, "args": (3, 1,),},
        {"func": player_thread, "args": (True, 0)},
        ]
    threads = [
        threading.Thread(target=thread["func"], args=thread["args"])
        for thread in le_threads
    ]
